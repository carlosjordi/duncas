...
@Component({
  selector: 'app-dungeon-ten',
  templateUrl: './dungeon-ten.component.html',
  styleUrls: ['./dungeon-ten.component.css']
})
export class DungeonTenComponent implements OnInit {
  ...
  getMonster(){
    this.monster = this.monsterService.generateUrone()
  }
