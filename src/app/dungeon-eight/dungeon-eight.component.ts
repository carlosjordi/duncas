...
@Component({
  selector: 'app-dungeon-eight',
  templateUrl: './dungeon-eight.component.html',
  styleUrls: ['./dungeon-eight.component.css']
})
export class DungeonEightComponent implements OnInit {
