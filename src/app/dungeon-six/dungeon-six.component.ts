...
@Component({
  selector: 'app-dungeon-six',
  templateUrl: './dungeon-six.component.html',
  styleUrls: ['./dungeon-six.component.css']
})
export class DungeonSixComponent implements OnInit {
  ...
  getMonster(){
    this.monster = this.monsterService.generateGargoyle()
  }
