...
@Component({
  selector: 'app-dungeon-seven',
  templateUrl: './dungeon-seven.component.html',
  styleUrls: ['./dungeon-seven.component.css']
})
export class DungeonSevenComponent implements OnInit {
  ...
  getMonster(){
    this.monster = this.monsterService.generateWizard()
  }
